...
void performance_test_3d_draw_imgui() {
	...
	ImGui::Text("Total Vertices: %lu", _total_vertices * performance_test_3d_amount_to_show);
	ImGui::Text("Total Triangles: %lu", (_total_vertices / 3) * performance_test_3d_amount_to_show);
	ImGui::End();
}
