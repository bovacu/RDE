...
//            if (SDL_GameControllerGetButton(gamecontroller, (SDL_GameControllerButton)i) == SDL_PRESSED) {
//                SDL_bool on_front = static_cast<SDL_bool>(i < SDL_CONTROLLER_BUTTON_PADDLE1 ||
//                                                          i > SDL_CONTROLLER_BUTTON_PADDLE4);
...
//
//            if (!set_LED) {
//                set_LED = static_cast<SDL_bool>(x < -8000 || x > 8000 || y > 8000);
//            }
//            if (set_LED) {
//                Uint8 r, g, b;
//
