...
namespace RDE {
    ...
    class TextureAtlasManager {
        ...
        public:
			...
			RDE_FUNC bool loadSpriteSheet(const std::string& _spriteSheetPath);
             ...
             */
			RDE_FUNC_ND Texture* getSubTexture(const std::string& _atlasName, const std::string& _textureName);
             ...
             * @return Atlas*
             */
			RDE_FUNC_ND Atlas* getAtlas(const std::string& _atlasName);
             ...
             */
			RDE_FUNC void unloadAtlas(const std::string& _atlasName);

            /**
             * @brief Debug function.
             * @return std::vector<TextureInfo>
             */
			RDE_FUNC_ND std::vector<TextureInfo> getTexturesInfo();
