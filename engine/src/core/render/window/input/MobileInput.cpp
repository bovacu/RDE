...
namespace GDE {
    ...
    void MobileInput::onTouchDown(SDL_Event& _event, RmlData* _rmlData) {
    ...
    void MobileInput::onTouchUp(SDL_Event& _event, RmlData* _rmlData) {
        pressure = 0;
    ...
    void MobileInput::onTouchMoved(SDL_Event& _event, RmlData* _rmlData) {
