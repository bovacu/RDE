...
void performance_test_3d_draw_imgui() {
	...
	size_t _total_vertices = rde_rendering_get_model_vertices_count(performance_test_3d_model);
	ImGui::Text("Total Vertices: %llu", _total_vertices * performance_test_3d_amount_to_show);
	ImGui::Text("Total Triangles: %llu", (_total_vertices / 3) * performance_test_3d_amount_to_show);
	ImGui::End();
}
...
void performance_test_3d_unload() {
	if(performance_test_3d_model != NULL) {
		rde_rendering_unload_model(performance_test_3d_model);
	}
...
void performance_test_3d_init() {
	performance_test_3d_camera = rde_struct_create_camera();
