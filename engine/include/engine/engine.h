...
RDE_FUNC_ENGINE void				rde_engine_entry_point(int _argc, char** _argv, rde_engine* _engine);


RDE_FUNC_ND 	rde_engine*			rde_engine_create_engine(int _argc, char** _argv);
...
RDE_FUNC_ND 	rde_display_info*	rde_engine_get_available_displays();
