...
SPECIALIZED_VEC2(int, 			rde_vec2I);
SPECIALIZED_VEC2(unsigned int, 	rde_vec2UI);
SPECIALIZED_VEC2(float, 		rde_vec2F);
...
#define SAFE_FUNC_POINTER_ARGS(_func, ...) if (_func != nullptr) (*_func)(__VA_ARGS__)
